    ...
    TipConform.prototype = {
      ...
      _render: function (ops) {
        ...
        var fragement = [],
          h = -1;
        fragement[++h] =
          "<div id=" + this.tipConformOuterId + ' class="ui-backdrop-outer">';
        fragement[++h] = '<div class="ui-backdrop"></div>';
        fragement[++h] =
          "<div id=" + this.tipConformId + ' class="ui-tip-conform" >';
        ...
        fragement[++h] = "</div>";
        $("body").append(fragement.join(""));
        this._initMember()._createHeaderBtn();
        if (ops.footer) {
      ...
      _createFooterBtn: function () {
        ...
        el.onclick = this._btnClickHandler.bind(this);
